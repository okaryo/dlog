...
func TestLogSubcommandShowsSpecifiedDate(t *testing.T) {
	...
	stdout.Reset()
	root.SetArgs([]string{"log", "--date", "2026-04-11"})
	if err := root.Execute(); err != nil {
		t.Fatalf("execute log --date: %v", err)
	}
...
func TestLogSubcommandRejectsInvalidDate(t *testing.T) {
	...
	root.SetArgs([]string{"log", "-d", "2026/04/12"})
	err := root.Execute()
	if err == nil {
...
func TestMarkdownSubcommandShowsSpecifiedDate(t *testing.T) {
	...
	current = time.Date(2026, 4, 12, 9, 0, 0, 0, time.FixedZone("JST", 9*60*60))
	stdout.Reset()
	root.SetArgs([]string{"md", "--date", "2026-04-11"})
	if err := root.Execute(); err != nil {
		t.Fatalf("execute md --date: %v", err)
	}
...
func TestMarkdownSubcommandRejectsInvalidDate(t *testing.T) {
	...
	root.SetArgs([]string{"md", "-d", "2026/04/12"})
	err := root.Execute()
	if err == nil {
		t.Fatalf("expected error")
	}
